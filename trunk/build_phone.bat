...
xcopy /e/c/i python appuifw2\
rem UID is autogenerated by ensymble based on the "appuifw2" directory name
ensymble.py simplesis --caption=appuifw2 --version=1.0.0 --drive=C --vendor="Arkadiusz Wahlig" --verbose appuifw2 appuifw2_1.0.0_unsigned_testrange.sis
rmdir /s/q appuifw2
